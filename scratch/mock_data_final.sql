-- ==========================================
-- FINAL COMPREHENSIVE MOCK DATA GENERATOR
-- (Adjusted to perfectly match your database schema)
...
BEGIN
  ...
  -- 5. Products (Using barcode and selling_price)
  INSERT INTO products (name, barcode, category_id, selling_price, purchase_price, stock_qty, low_stock_alert_qty)
  ...
  -- 6. Quotation (Using customer_id)
  INSERT INTO quotations (customer_id, quotation_no, date, subtotal, discount, grand_total, status, items)
  VALUES (
    cust1, 'QT-001', CURRENT_DATE - INTERVAL '5 days', 120000, 0, 120000, 'pending',
    ('[{"name": "Dell XPS 15", "qty": 1, "price": 120000, "total": 120000}]')::jsonb
  );

  -- 7. Proforma Invoice (Stored as bill with status 'proforma', using customer_id)
  ...
  -- 8. Sales Invoices (Bills, using customer_id)
  INSERT INTO bills (customer_id, bill_no, date, subtotal, discount, grand_total, status, items)
  VALUES (
  ...
  -- 9. Sales Return (Using customer_id)
  ...
  -- 10. Delivery Challan (Using customer_id)
  INSERT INTO delivery_challans (customer_id, challan_no, date, status, items)
  VALUES (
    cust1, 'CH-001', CURRENT_DATE - INTERVAL '1 day', 'Delivered',
    ('[{"name": "Dell XPS 15", "qty": 1}]')::jsonb
  );

  -- 11. Payment In (Bill Payments, using party_id and bill_id)
  INSERT INTO bill_payments (party_id, bill_id, amount, date, payment_mode, notes, payment_no)
  VALUES (cust1, bill1, 50000, CURRENT_DATE - INTERVAL '1 day', 'UPI', 'Advance payment', 'PAY-IN-001');

  -- 12. Purchase Invoices (Using supplier_id)
  ...
  -- 13. Purchase Return (Using supplier_id)
  ...
  -- 14. Payment Out (Purchase Payments, using supplier_id and purchase_id)
  INSERT INTO purchase_payments (supplier_id, purchase_id, amount, date, payment_mode, notes, payment_no)
  VALUES (supp1, pur1, 100000, CURRENT_DATE - INTERVAL '5 days', 'Bank Transfer', 'First Installment', 'PAY-OUT-001');
