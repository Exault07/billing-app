-- ==========================================
-- FINAL FIXED MOCK DATA GENERATOR (V3)
...
DECLARE
  ...
  pur1 uuid;
BEGIN
  -- FIX 1: Remove strict status constraints so the frontend can freely use 'pending', 'proforma', etc.
  ALTER TABLE bills DROP CONSTRAINT IF EXISTS bills_status_check;
  ALTER TABLE quotations DROP CONSTRAINT IF EXISTS quotations_status_check;
  
  -- The refactored purchase_invoices table also has this constraint
  ...
  -- 6. Quotation (Using bill_no and status pending)
